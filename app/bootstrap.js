...
setTimeout(()=>{const v=document.querySelector('.version');if(v)v.textContent='BETA '+cfg.version},0);
window.FutLiveApp={game,giftHud,players,team1,team2,triggerForce,isPaused:()=>paused};window.FutLiveTest={force:triggerForce};
})();