...
function ensureOutOfPlay(){if(document.querySelector('script[data-futlive-outofplay]'))return;const s=document.createElement('script');s.src='./components/out-of-play-system.js?v=0.57-out1';s.dataset.futliveOutofplay='1';document.head.appendChild(s)}
function boot(){
  const e=window.FutLiveFootballEngine;if(!e||!e.players?.length){setTimeout(boot,40);return}if(e.__ballContactV053){ensureOutOfPlay();return}e.__ballContactV053=true;
